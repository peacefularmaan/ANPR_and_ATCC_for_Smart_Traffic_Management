...
license_plate_cascade = cv2.CascadeClassifier(r"C:\Users\mgree\Downloads\ANPR_ATCC_SMART_TRAFFIC_MANAGEMENT (2)\ANPR_ATCC_SMART_TRAFFIC_MANAGEMENT\models\YOLO\haarcascade_russian_plate_number.xml")
